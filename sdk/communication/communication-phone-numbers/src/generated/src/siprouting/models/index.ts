 ...
 */
export type SipRoutingClientGetSipConfigurationResponse = SipConfiguration & {
  /**
 ...
 * Optional parameters.
 */
export interface SipRoutingClientPatchSipConfigurationOptionalParams
 ...
 */
export type SipRoutingClientPatchSipConfigurationResponse = SipConfiguration & {
  /**
   * The underlying HTTP response.
   */
  _response: coreHttp.HttpResponse & {
